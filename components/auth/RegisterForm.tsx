"use client";
import { FolderKanban, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
import { GoogleIcon, GitHubIcon } from "@/components/other-icons/icons";
import { Button } from "@/components/ui/button";
import { authClient } from "@/lib/auth-client";
import { Input } from "@/components/ui/input";
import { notifier } from "@/utils/tostado";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      notifier.success({
        ...
        message:
          "You're successfully logged in and ready to work on your projects",
      });
    } catch (error) {

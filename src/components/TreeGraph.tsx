...
export default function TreeGraph({
  ...
  useEffect(() => {
    setLocalTasks(tasks!.filter((task) => task.parentTaskId === null));
  }, [tasks]);
          ...
          <>
            ...
            <div className="flex-row space-x-2">
              <Button
                ...
                size="sm"
                title="Add Subtask"
                onClick={() => openAddSubtask(selectedTask)}
              >
                ...
                >
                  <Card
                    className={`w-full h-auto cursor-pointer transition-all hover:shadow-lg hover:scale-105 ${
                      ...
                      ${node.task.id === selectedTask?.id ? "shadow-lg scale-105 border-2 border-blue-500" : ""}`}
